...
const Carousel = () => {
    ...
    return (
        <div className="relative w-full overflow-hidden bg-blue-500" style={{ borderRadius: '0.5rem' }}>
                ...
                {crouselMenu.map((menuItem, index) => (
                    <div key={index} className="w-full h-full flex justify-center items-center">
                        <div className=" rounded-lg p-4 flex justify-center">
                            <div className=' w-[23rem] h-[13rem] ms-2 p-2'>
                                <div className='items-start'>
                                    ...
                                    <div className=' h-[5rem] w-[70%] mt-2'>
                                        <div>
                            ...
                            <div className=' flex w-[12rem] h-[13rem]  items-center justify-center'>
            ...
            <div className="absolute top-4 right-4 flex">
                {crouselMenu.map((_, index) => (
                    <button
                        key={index}
                        className={`w-[0.5rem] h-[0.5rem] rounded-full mx-1 focus:outline-none ${activeIndex === index ? 'bg-white' : 'bg-blue-800'
                            }`}
